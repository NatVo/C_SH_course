...
namespace UniversityLib
{
    public class UniversityManageInfo
    {
        ...
        private UniversityPrintInfo _universityPrintInfo = new UniversityPrintInfo();
        ...
        public void AddStudentInfo(string studentFirstName, string studentLastName, string studentGroupName)
        {
            try
            {
                _universityAddInfo.InsertStudent(studentFirstName, studentLastName, studentGroupName);
                Console.WriteLine($"\nSuccessfully added student: {studentFirstName} {studentLastName} to group: {studentGroupName}");
            }
            catch (Exception exception)
            {
                Console.WriteLine($"\nUnable to add student: '{studentFirstName} {studentLastName}' - {exception.Message}");
            }
        }
